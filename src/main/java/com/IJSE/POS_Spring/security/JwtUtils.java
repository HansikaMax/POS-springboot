...
private Key key(){
    return Keys.hmacShaKeyFor(Decoders.BASE64.decode(secret)); //generating key with secret
}
...
public String generateJwtToken(Authentication authentication){
    ...
    return Jwts.builder()
                ...
                .setExpiration(new Date(new Date().getTime() + 1000*60*60*24)) //expire in 24 hours. starts with miliseconds
